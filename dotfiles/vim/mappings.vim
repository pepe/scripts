...
" Quickfix
nnoremap <Leader>cn :wa<CR>:cn<CR>
nnoremap <Leader>cp :wa<CR>:cp<CR>
...
"
" Git
nnoremap <silent> <Leader>ga :wa<CR> :Git add %<CR>
nnoremap <silent> <Leader>gs :wa<CR> :Git status<CR>
